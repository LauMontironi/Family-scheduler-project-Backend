...
ACCES_TOKEN=int(os.getenv("ACCESS_TOKEN_EXPIRE_MINUTES"))
...
def create_token(data: dict):
    ...
    expire = datetime.now(tz=timezone.utc) + timedelta(minutes=ACCES_TOKEN)
    datacopy_to_encode.update({"exp": int(expire.timestamp())})
